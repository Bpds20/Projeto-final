...
def changeplayer():
    ...
    if c==0:
        if a==1:
            a=2
            playerturn['text']="   Turno: Jogador 2!   "
            return
        else:
            a=1
            playerturn['text']="   Turno: Jogador 1!   "
            return
    else:
        
        if a==1:
            a=2
            playerturn['text']="   Turno: BOT!   "
            return
        else:
            a=1
            playerturn['text']="   Turno: Jogador   "
            return
...
def dificuldade3(state):
    ...
    if not safeboard:
        i=randint(0,2)
        j=randint(0,3)
        print("Não encontrei jogadas seguras.")
        return (i,j,0) # indeterminado
    else:
...
def check_win():
    ...
    global bu
    x=0
    temp = copy_states() #nao funciona sem isto nao sei porque WTF.
    for y in range(0,4):
